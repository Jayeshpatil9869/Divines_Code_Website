...
import { Mail, Phone, MessageSquare, MapPin, Instagram, Linkedin, Globe } from 'lucide-react';
               ...
               <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-start">
                  <div className="flex flex-col gap-8">
                     <div className="flex flex-col gap-2">
                        {[
                           { icon: Mail, label: "Email", value: "divinescode@gmail.com", href: "mailto:divinescode@gmail.com" },
                           { icon: Phone, label: "Phone", value: "+91 91123 55749", href: "tel:+919112355749" },
                           { icon: Globe, label: "Website", value: "divinescode.com", href: "https://divinescode.com" },
                           { icon: MapPin, label: "Location", value: "34, Dhandai Jogeshwari Nagar, Mauli Nagar, Prerna Colony, Malegaon, Maharashtra 423105", href: null }
                        ].map((item, i) => (
                     ...
                     <div className="px-4 mt-2">
                        ...
                        <div className="flex items-center gap-4">
                           <a href="https://www.instagram.com/divine_code_41" target="_blank" rel="noopener noreferrer" className="size-10 flex items-center justify-center rounded-full bg-white border border-neutral-200 text-primary hover:bg-primary hover:text-white transition-all duration-300">
                              <Instagram size={20} />
                           </a>
                           <a href="https://www.linkedin.com/company/110118328" target="_blank" rel="noopener noreferrer" className="size-10 flex items-center justify-center rounded-full bg-white border border-neutral-200 text-primary hover:bg-primary hover:text-white transition-all duration-300">
                              <Linkedin size={20} />
                           </a>
                        </div>
                     </div>
